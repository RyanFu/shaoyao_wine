                ...
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    ...
                    <el-form-item label="缩略图" prop="scene_pic_url">
                        <el-upload class="image-uploader" name="scene_pic_url"
                                   action="https://127.0.0.1:8360/admin/upload/topicThumb" :show-file-list="false"
                    ...
                    <el-form-item label="内容">
                         <vue-editor v-model="infoForm.content" useCustomImageHandler @imageAdded="handleImageAdded"></vue-editor>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            handleImageAdded(file, Editor, cursorLocation, resetUploader){
                ...
                formData.append('scene_pic_url', file)
                console.log(formData);
                this.axios({
                  url: '/upload/topicThumb',
                  method: 'POST',
                  data: formData
                })
                .then((result) => {
            ...
            handleUploadImageSuccess(res, file) {
                if (res.errno === 0) {
                    switch (res.data.name) {
                        //专题图片
                        case 'scene_pic_url':
                          this.infoForm.scene_pic_url = res.data.url;
                            break;
                    }
                }
            },
