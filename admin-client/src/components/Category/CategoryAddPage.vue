                ...
                <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
                    ...
                    <el-form-item label="图标" prop="wap_banner_url">
                        <el-upload class="image-uploader" name="wap_banner_pic"
                                   action="https://127.0.0.1:8360/admin/upload/categoryWapBannerPic" :show-file-list="false"
                    ...
                    <el-form-item label="是否展示在首页">
                        <el-switch v-model="infoForm.is_home"></el-switch>
                    </el-form-item>
                    <el-form-item>
    ...
    methods: {
      ...
      handleUploadImageSuccess(res, file) {
        if (res.errno === 0) {
          switch (res.data.name) {
            //分类图片
            case 'wap_banner_url':
              this.infoForm.wap_banner_url = res.data.url;
              break;
          }
        }
      },
      ...
      getInfo() {
        ...
        this.axios.get('category/info', {
          ...
          resInfo.is_home = resInfo.is_home ? true : false;
